...
async def handler(event):
    ...
    logger.info(f"Received message from staging channel {staging_chat_id}")
    ...
    try:
        ...
        logger.info(f"Message successfully forwarded to production channel {production_channel}.")
