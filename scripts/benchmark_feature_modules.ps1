...
$configs = @(
  ...
  @{ Name = "flow_or_med"; Overrides = @{ in_95 = $true; in_96 = "Breakout Only"; in_98 = "Volume OR Delta"; in_99 = "Majority"; in_100 = "Medium" } },
  @{ Name = "flow_and_med"; Overrides = @{ in_95 = $true; in_96 = "Breakout Only"; in_98 = "Volume + Delta"; in_99 = "Majority"; in_100 = "Medium" } },
  @{ Name = "flow_and_big"; Overrides = @{ in_95 = $true; in_96 = "Breakout Only"; in_98 = "Volume + Delta"; in_99 = "Majority"; in_100 = "Big" } },
  @{ Name = "swing_1p2"; Overrides = @{ in_113 = $true; in_114 = "All Signals"; in_117 = 1.2 } },
  @{ Name = "swing_1p5"; Overrides = @{ in_113 = $true; in_114 = "All Signals"; in_117 = 1.5 } },
  @{ Name = "cvd_reject"; Overrides = @{ in_107 = $true; in_108 = "Reject Only"; in_109 = 3; in_110 = 3; in_111 = 20 } },
  @{ Name = "flow_or_med_swing"; Overrides = @{ in_95 = $true; in_96 = "Breakout Only"; in_98 = "Volume OR Delta"; in_99 = "Majority"; in_100 = "Medium"; in_113 = $true; in_114 = "All Signals"; in_117 = 1.2 } },
  @{ Name = "flow_and_med_swing"; Overrides = @{ in_95 = $true; in_96 = "Breakout Only"; in_98 = "Volume + Delta"; in_99 = "Majority"; in_100 = "Medium"; in_113 = $true; in_114 = "All Signals"; in_117 = 1.2 } },
  @{ Name = "flow_and_med_cvd"; Overrides = @{ in_95 = $true; in_96 = "Breakout Only"; in_98 = "Volume + Delta"; in_99 = "Majority"; in_100 = "Medium"; in_107 = $true; in_108 = "Reject Only"; in_109 = 3; in_110 = 3; in_111 = 20 } },
  @{ Name = "swing_cvd"; Overrides = @{ in_113 = $true; in_114 = "All Signals"; in_117 = 1.2; in_107 = $true; in_108 = "Reject Only"; in_109 = 3; in_110 = 3; in_111 = 20 } },
  @{ Name = "all_three"; Overrides = @{ in_95 = $true; in_96 = "Breakout Only"; in_98 = "Volume + Delta"; in_99 = "Majority"; in_100 = "Medium"; in_107 = $true; in_108 = "Reject Only"; in_109 = 3; in_110 = 3; in_111 = 20; in_113 = $true; in_114 = "All Signals"; in_117 = 1.2 } }
)
...
$minTradeThreshold = [math]::Max(20, [math]::Floor($baseline.Trades * 0.55))
$eligible = $ethResults | Where-Object { $_.Trades -ge $minTradeThreshold }
$bestEth = $eligible | Sort-Object @{Expression = "PF"; Descending = $true}, @{Expression = "NP"; Descending = $true}, @{Expression = "WR"; Descending = $true} | Select-Object -First 1
$bestConfig = $configs | Where-Object { $_.Name -eq $bestEth.Config } | Select-Object -First 1
...
# Restore chart to ETH with the selected ETH pattern.
node src/cli/index.js symbol $EthSymbol | Out-Null
Start-Sleep -Milliseconds 1800
Set-Inputs (Merge-Inputs $baseInputs $bestConfig.Overrides)
Start-Sleep -Milliseconds 1500
